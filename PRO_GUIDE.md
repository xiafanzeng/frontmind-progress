...
Return handoff.json, HANDOFF.md and files/ containing complete changed files at repository-relative paths. handoff.json contains formatVersion:1, module:"progress", the full baseCommit, mode:"changes", and an explicit delete list. Missing files are never treated as deletions. HANDOFF.md describes behavior, dependency changes, validations and limitations.
...
```text
Read https://github.com/xiafanzeng/frontmind-progress/tree/<full-40-character-SHA>
