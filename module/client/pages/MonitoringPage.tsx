import type { MonitoringQuestionSeed } from "../domain";
import { useBusinessWorkspace } from "../host-runtime";
import { activeEnterpriseProjectId } from "../host-runtime";
  ...
  return (
    <div className="page-content monitoring-reference-page">
      ...
      {initialLoading ? (
        ...
        <div className="monitoring-reader-frame" hidden={isWorkbench && Boolean(monitorEditor || pendingRun)}>
          <MonitoringWorkspace
