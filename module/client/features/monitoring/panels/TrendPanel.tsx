...
export default function TrendPanel({
  ...
  const [preferredView, setView] = useState<TrendView>("mentionRate");
  const visibleViews = views.filter(
    (item) => showIndustryMetrics || item.id === "sentiment",
  );
  const view = showIndustryMetrics ? preferredView : "sentiment";
          ...
          <div className="fm-trend-legend" aria-hidden="true">
            ...
            {view === "sentiment" && (
              <>
                ...
                <span className="unknown">未判定</span>
              </>
            )}
          </div>
