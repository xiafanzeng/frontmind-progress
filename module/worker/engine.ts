...
export interface WorkerProcessorPort { handle(job: import("./job-types.js").WorkerJob, signal: AbortSignal): Promise<void>; }
...
export class WorkerEngine {
  ...
  constructor(
    ...
    private readonly processor: WorkerProcessorPort,
